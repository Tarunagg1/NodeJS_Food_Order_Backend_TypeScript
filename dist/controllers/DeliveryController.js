...
var Customer_dtos_1 = require("../dto/Customer.dtos");
...
var DeliverySignUp = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                deliveryUserInputs = (0, class_transformer_1.plainToClass)(Customer_dtos_1.CreateDeliveryUserInput, req.body);
            ...
            case 5:
                ...
                return [4 /*yield*/, (0, PasswordUtility_1.GenerateSignature)({
                        _id: result._id,
                        email: result.email,
...
var DeliveryLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                loginInputs = (0, class_transformer_1.plainToClass)(Customer_dtos_1.UserLoginInput, req.body);
                return [4 /*yield*/, (0, class_validator_1.validate)(loginInputs, { validationError: { target: true } })];
            case 1:
                validationError = _a.sent();
                if (validationError.length > 0) {
                    return [2 /*return*/, res.status(400).json(validationError)];
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, PasswordUtility_1.ValidatePassword)(password, deliveryUser.password, deliveryUser.salt)];
            case 3:
                validation = _a.sent();
                if (validation) {
...
var EditDeliveryProfile = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                deliveryUser = req.user;
                customerInputs = (0, class_transformer_1.plainToClass)(Customer_dtos_1.EditCustomerProfileInput, req.body);
